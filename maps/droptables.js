...
const ENEMY_DROP_TABLES = {
    'default': [
        {type: 'rupee', value: 1, chance: 1.0},   // 30% chance for 1 rupee
        {type: 'heart', value: 2, chance: 0.0},   // 20% chance for 1 heart (2 half-hearts)
        {type: 'bomb', value: 1, chance: 0.0},     // 10% chance for 1 bomb
        {type: 'fairy', value: 0, chance: 0.0}   // 5% chance for fairy (value unused)
    ],
    // 'octorok': [
