// WalkingAIMovementSystem - controls ground-based enemies with random walking behavior
class WalkingAIMovementSystem {
    update(deltaTime, game) {
        for (let entity of game.entities) {
            if (entity.walkingAIMovement && entity.velocity && entity.facing && entity.position) {
                ...
                entity.walkingAIMovement.changeTimer += deltaTime;
                
                // Time to change direction?
                if (entity.walkingAIMovement.changeTimer >= entity.walkingAIMovement.changeInterval) {
                    this.changeDirection(entity, game);
                    entity.walkingAIMovement.changeTimer = 0;
                }
            }
        }
    }
    ...
    setDirection(entity, direction) {
        const speed = entity.walkingAIMovement.speed;
